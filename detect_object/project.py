...
image_template = cv2.imread("./images/test.jpg")
...
while True :
    ...
    cropped = frame[bottom_right_y:bottom_right_y, top_left_x:top_left_x]
    ...
    if matches > threshold:
        cv2.rectangle(frame , (top_left_x, top_left_y), (bottom_right_x, bottom_right_y), (255, 0, 0), 2)
        cv2.putText(frame , 'Objects Found' , (50,50) , cv2.FONT_HERSHEY_PLAIN, 1, (255,255,255), 2)
