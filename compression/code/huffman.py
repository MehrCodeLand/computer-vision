...
# haffman code like binary code [ 0 , 1]
...
# compare 
import sys 
bgr = cv2.imread('images/face.png')
print(sys.getsizeof(image))
print(sys.getsizeof(decoded_image))
print(sys.getsizeof(bgr))

# save new image 
cv2.imwrite('compression_by_huffman.png' , decoded_image)
